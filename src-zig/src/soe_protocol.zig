...
pub const ApplicationParams = struct {
    ...
    on_session_opened: *const fn (self: *anyopaque, session: *SoeSessionHandler) void,
    ...
    pub fn callOnSessionOpened(self: *const ApplicationParams, session: *SoeSessionHandler) void {
