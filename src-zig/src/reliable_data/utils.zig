...
pub fn readMultiDataLen(source: []const u8, offset: *usize) u32 {
    var value: u32 = 0;
...
pub fn getMultiDataLenSize(length: u32) u3 {
    if (length < 0xFF) {
        return 1;
...
pub fn writeMultiDataLen(dest: []u8, value: u32, offset: *usize) void {
    if (value < 0xFF) { // TODO: This may need to be 0xFE (254) instead? But only here, not in the read variant
